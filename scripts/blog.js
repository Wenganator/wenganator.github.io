...
// Load the tags-container.html file dynamically and insert its content into the placeholder (<div id="tagsContainer"></div>) in each blog page
document.addEventListener('DOMContentLoaded', () => {
    const tagsContainer = document.getElementById('tagsContainer');
    if (tagsContainer) {
        fetch('/blog/tags-container.html')
            .then(response => {
                if (!response.ok) {
